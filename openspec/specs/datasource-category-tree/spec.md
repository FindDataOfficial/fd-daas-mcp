# datasource-category-tree

## Purpose

A hierarchical `categories` table (self-referencing `parent_id`) with tools to create, move (cycle-safe), delete, and traverse the category tree, including datasource counts per category.
