# investor-personas Specification

## Purpose
TBD - created by syncing change add-trading-mcp. Update after archive.

Defines five investor persona CrewAI Agent factories (Warren Buffett, George Soros, Peter Lynch, Ray Dalio, Jim Simons), each with a distinct investment philosophy. Personas produce independent BUY/HOLD/SELL analyses that the trading pipeline later merges into a consensus report.
