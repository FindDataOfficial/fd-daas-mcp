"""
Registry module for yfinance function metadata.

Backed by SQLAlchemy database (default SQLite, swappable via YFINANCE_DATABASE_URL).
Maintains the same API surface as the akshare harness:
list_functions, search_functions, get_function_info, get_categories,
get_category_functions.

All functions return dicts matching the registry.json format.
"""
...
class RegistryService:
    """Query orchestration for yfinance function metadata.
