...
_ALERTS_MCP = Path(__file__).resolve().parents[1] / "src" / "fd_daas_mcp" / "mcp" / "alerts"
sys.path.insert(0, str(_ALERTS_MCP))
from alert_database import get_db  # noqa: E402
from fd_daas_mcp.models import AlertEvent, AlertRule  # noqa: E402
...
def _ObsRow(source, date, value):
    ...
    from fd_daas_mcp.models import Observation
