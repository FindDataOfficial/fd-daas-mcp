...
# Make the package importable regardless of the cwd pytest was invoked from.
# src-layout: fd_daas_mcp lives under src/. models is vendored as
# fd_daas_mcp.models, so no separate models/ dir on sys.path.
...
from fd_daas_mcp import registry  # noqa: E402
