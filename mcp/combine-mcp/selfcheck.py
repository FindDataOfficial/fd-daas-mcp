"""Self-check for combine-mcp — no framework, just asserts.

Run:  cd mcp/combine-mcp && uv run python selfcheck.py
...
import combine_database as cdb  # noqa: E402
from combine_tools import _resolve_input, _dotted, make_chain_tool  # noqa: E402
