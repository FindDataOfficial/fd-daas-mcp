...
Run:  cd mcp/combine-mcp && uv run python seed_example.py
"""
...
from combine_database import get_combine_db  # noqa: E402
...
def main() -> None:
    ...
    print("\nexample composite now serves (on next combine-mcp start):")
