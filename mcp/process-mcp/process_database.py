"""Database helpers for process-mcp.
...
from models import Base, DaasSource, IndicatorRule, ProcessResult, ProcessRule
...
class ProcessDatabase:
    ...
    def __init__(self, database_url: Optional[str] = None):
        ...
        # mcp/process-mcp`, which sets cwd to mcp/process-mcp and would break a
