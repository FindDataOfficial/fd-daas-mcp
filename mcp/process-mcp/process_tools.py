"""process-mcp tools — multi-model LLM extraction (long text + images).

No SDK: calls an OpenAI-compatible /chat/completions endpoint via httpx.
Reuses the LLM_API_KEY / LLM_BASE_URL / LLM_MODEL env convention (see
cnreport_tools.llm_config), generalized to a named model registry.
