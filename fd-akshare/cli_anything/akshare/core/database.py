...
Provides SQLAlchemy engine and session management. Reads AKSHARE_DATABASE_URL
from environment (defaults to SQLite at metadata/daas.db). Auto-creates
tables on first use.
...
from cli_anything.akshare.core.models import Base
...
class Database:
    ...
    Reads AKSHARE_DATABASE_URL env var; defaults to SQLite at metadata/daas.db.
