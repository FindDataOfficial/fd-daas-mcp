...
from fd_daas_mcp.models import Function, FunctionColumn, DataSnapshot, Base
...
class TestDatasourceTools:
    ...
    def test_list_registry_datasources_empty(self, clean_db):
        from leader_tools import list_registry_datasources
        ...
        result = list_registry_datasources()
        assert "No datasources configured" in result

    def test_list_registry_datasources_with_data(self, clean_db):
        from leader_tools import list_registry_datasources, toggle_datasource
    ...
    def test_list_registry_datasources_disabled(self, clean_db):
        from leader_tools import list_registry_datasources, toggle_datasource
    ...
    def test_toggle_datasource_unmark(self, clean_db):
        from leader_tools import toggle_datasource, list_registry_datasources
