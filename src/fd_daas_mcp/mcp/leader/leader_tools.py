...
from fd_daas_mcp.models import Function, FunctionColumn, DataSnapshot
...
def search_registry_functions(query: str, harness: Optional[str] = None) -> str:
...
def get_registry_function_detail(harness: str, command: str) -> str:
...
def list_harness_categories(harness: Optional[str] = None) -> str:
...
def list_registry_datasources(harness: Optional[str] = None) -> str:
...
def _get_crewai_tools():
    ...
    return [
        ...
        crewai_tool("search_registry_functions")(search_registry_functions),
        crewai_tool("get_registry_function_detail")(get_registry_function_detail),
        crewai_tool("list_harness_categories")(list_harness_categories),
