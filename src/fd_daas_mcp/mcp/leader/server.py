...
Exposes the database query tools (list_harnesses, search_registry_functions,
get_registry_function_detail, list_harness_categories, find_functions_by_column) as MCP
...
# is mcp/, parent.parent.parent is daas/). The shared .env (LLM_*,
...
app.add_tool(search_registry_functions)
app.add_tool(get_registry_function_detail)
app.add_tool(list_harness_categories)
app.add_tool(find_functions_by_column)
app.add_tool(list_registry_datasources)
