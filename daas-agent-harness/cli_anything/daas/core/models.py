"""
SQLAlchemy models for DAAS multi-source function registry.

Three tables:
  - sources: one row per data source (akshare, worldbank, ckan, cnstats)
  - functions: one row per callable data function, linked to a source
...
class Observation(Base):
    """Unified time-series observations from all data sources."""
