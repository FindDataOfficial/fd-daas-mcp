---
name: fd-coding-daas-datasource-builder
description: >
...
# fd-coding-daas-datasource-builder
...
```bash
uv run python .claude/skills/fd-coding-daas-datasource-builder/scripts/analyze_project.py <project-root> [--package <pkg>] [--min-score 0.3] > analysis.json
```
...
```bash
uv run python .claude/skills/fd-coding-daas-datasource-builder/scripts/match_existing.py > existing.json
```
...
```bash
uv run python .claude/skills/fd-coding-daas-datasource-builder/scripts/validate_descriptor.py daas.descriptor.json
```
...
```bash
uv run python .claude/skills/fd-coding-daas-datasource-builder/scripts/gen_cli.py daas.descriptor.json --import-root <pkg> --out daas_cli.py
```
