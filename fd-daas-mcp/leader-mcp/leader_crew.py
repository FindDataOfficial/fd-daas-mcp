...
Usage (without CrewAI, direct tools):
    from leader_mcp.leader_tools import search_functions, list_harnesses
    print(list_harnesses())
    print(search_functions("股票"))
"""
...
class LeaderCrew:
    ...
    def _ask_with_crewai(self, question: str, verbose: bool) -> str:
        ...
        searcher = Agent(
            ...
            backstory=(
                ...
                "to see what's available, search_functions for text search, "
                "get_function_detail for full info, list_categories to browse, "
        ...
        task = Task(
            description=(
                ...
                "2. Use search_functions or find_functions_by_column to find matches.\n"
                "3. Use get_function_detail for any specific functions.\n"
    ...
    def _ask_direct(self, question: str) -> str:
        ...
        if detail_match:
            ...
            if func_name and len(func_name) >= 3:
                ...
                try:
                    ...
                    session.close()
                return f"Function '{func_name}' not found. Try search_functions first."
        ...
        lines.append(search_functions(keywords))
        lines.append("")
